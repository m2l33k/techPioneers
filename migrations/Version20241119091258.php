 ...
 */
final class Version20241119091258 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id_category INT AUTO_INCREMENT NOT NULL, nom_category VARCHAR(255) NOT NULL, Id_Evenement INT NOT NULL, INDEX IDX_64C19C111D38D62 (Id_Evenement), PRIMARY KEY(id_category)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenement (Id_Evenement INT AUTO_INCREMENT NOT NULL, titre_evenement VARCHAR(255) NOT NULL, date_evenement DATETIME NOT NULL, description_evenement LONGTEXT NOT NULL, organisateur_evenement VARCHAR(255) NOT NULL, lien_evenement VARCHAR(255) NOT NULL, lieu_evenement VARCHAR(255) NOT NULL, PRIMARY KEY(Id_Evenement)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C111D38D62 FOREIGN KEY (Id_Evenement) REFERENCES evenement (Id_Evenement)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP FOREIGN KEY FK_64C19C111D38D62');
