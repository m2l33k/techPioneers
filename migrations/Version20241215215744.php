 ...
 */
final class Version20241215215744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (idEvenement INT AUTO_INCREMENT NOT NULL, titre_evenement VARCHAR(255) NOT NULL, date_evenement DATETIME NOT NULL, description_evenement LONGTEXT NOT NULL, organisateur_evenement VARCHAR(255) NOT NULL, lien_evenement VARCHAR(255) NOT NULL, lieu_evenement VARCHAR(255) DEFAULT NULL, idCategory INT NOT NULL, INDEX IDX_B26681E55EF339A (idCategory), PRIMARY KEY(idEvenement)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
