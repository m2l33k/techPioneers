...
final class ForumController extends AbstractController{
    ...
    #[Route('/{Id_Forum}', name: 'app_forum_show', methods: ['GET'])]
    ...
    #[Route('/{Id_Forum}/edit', name: 'app_forum_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{Id_Forum}', name: 'app_forum_delete', methods: ['POST'])]
    public function delete(Request $request, Forum $forum, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$forum->getId_Forum(), $request->getPayload()->getString('_token'))) {
