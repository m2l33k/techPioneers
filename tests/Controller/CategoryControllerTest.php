...
final class CategoryControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'category[Nom_Category]' => 'Testing',
            'category[evenement]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNom_Category('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'category[Nom_Category]' => 'Something New',
            'category[evenement]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNom_Category());
